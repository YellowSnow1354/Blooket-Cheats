...
1. Importing one of the Bookmarklets.html files using [these instructions](https://github.com/YellowSnow1354/Blooket-Cheats/blob/main/tutorial/readme.md)
...
Make sure you're running it properly (see [How to use](https://github.com/YellowSnow1354/Blooket-Cheats#how-to-use), if it still doesn't work and other cheats do, then [make an issue](https://github.com/YellowSnow1354/Blooket-Cheats/issues)
</details>
